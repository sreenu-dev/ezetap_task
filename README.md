...
### Scenario Understanding:
    As to create adim page the main points I noticed is
    1. Movies the Primary Entity
...
### Assumptions Made
    In the Moives Page we show the list of movies along with options to Filter and Sort on particular columns. When we click on view details we be shown the details of theatres. So theatre is taken is the child entity of moive and all edit option was given for theatres.
...
### Libraries Used:
    - Packages Used in Backend:
      ...
      - CORS: Cross Origin Resource sharing is used to accept the request from unkown sources(Development Purpose)
